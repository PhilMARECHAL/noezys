...
- **Purchase minimum >= 2.3 m2 (raised from 2.1 on 2026-08-17: Q12 A/b adoption lifted the VSMA worst duty to 1.77 m2; governing rule floor = worst method x1.25) — CLIENT DECISIONS 2026-08-15 (M-1) + 2026-08-17: full VSMA factor method** (worst factor duty 1.65 m2 in 2C — the model's 1.42 m2 lacks the composition factors; ×1.25 margin). BUT the vendor must verify the deck area for the FULL 100 t/h wet bed load at 1.7 mm by its own bed-depth method — a fine wet cut at this tonnage will realistically need substantially more area than any cut-duty minimum. The vendor sizing at 100 t/h wet GOVERNS over this minimum (caveat unchanged).

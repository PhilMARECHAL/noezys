...
| [RC.2.md](RC.2.md) | Smooth-roll crusher stage 2 (2 units) | **2 x 22 t/h dry with gap range 3.4 down to 1.5 mm — the 1.5 mm min-gap capability is a vendor-confirmation gate (mode F infeasible without it)**; gradation test requirement; gap-drift instrumentation 0.1 mm; per-unit bearing monitoring |
...
| [SC.B.md](SC.B.md) | Double-deck 2/1.5 product screen | **TOP RPN of the park (deck-2.0 wear 252): certified-aperture quick-change panels, 2 spare sets, designed-in gauging access — D6 margin only 0.8 pt**; sharpness guarantee at 2.0 mm; anti-pegging provision; areas >= 6.5 / 5.6 m2 |
| [SP.36.md](SP.36.md) | Air classifier + fan (65 um) | **Fan >= 420 m3/h with VFD turndown — soft-rock envelope sizing (client decision 2026-08-15, error-hunt PD-3**; was an unguarded 207 m3/h reference); cut certification by sieve/laser at acceptance (closes the NOT-CERTIFIED alert); eta_cl guarantee vs the optimistic 0.75 [H]; wheel/vane wear liners; fan bearing monitoring; Q_air instrument |
| [CL.38.md](CL.38.md) | Static cyclone | Replaceable cone/apex wear liners + thickness ports; dP tappings; grade-efficiency value table; tail dust loading stated (input to the MISSING sub-4 um polishing bag filter design item) |

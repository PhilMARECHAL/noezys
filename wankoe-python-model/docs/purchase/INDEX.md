...
**VENDOR OFFERS REGISTER (opened 2026-08-17 — client order: dedicated folder, total traceability):** [offers/REGISTER.md](offers/REGISTER.md) — every received offer archived UNMODIFIED (SHA-256 verified) with a summary sheet mapping items to machine tags and flagging gaps vs the RFQ gates. First entry: OF-001 Guildco (SI8202 screen → SR.5007; LPS625-3 toothed roller crusher → CR.5009; ZAR 4.31 M ex-VAT FOB Shanghai). Offers arrive through the CLIENT's channel — the NOEZYS RFQ package remains DRAFT/SENDING SUSPENDED.

/* Renders pub-square.html (FR or EN) frame-by-frame, then encodes to MP4.
...
await page.goto('file://' + path.join(DIR, 'pub-square.html') + '?lang=' + LANG);
...
const out = path.join(DIR, `noezys-pub-carre-${LANG}.mp4`);
execSync(
